...
window.onload=() => {
  ...
  async function pedir() {
    ...
    const response = await fetch(`http://127.0.0.1:3000/user/${id_user_logged}`,{
        headers: {
                                    ...
                                    document.getElementById("cidade").value!==null){
                                        ...
                                        await swal.fire({
                                            ...
                                            preConfirm: async (event) =>{
                                                ...
                                                const response = await fetch(`http://127.0.0.1:3000/user/requestLicense`, {
                                                    headers: {
                                                      'Content-Type': 'application/json',
                                                      'Accept': 'application/json'
                                                    },
...
const renderLicences = async () =>{
    ...
    const response2= await fetch(`http://127.0.0.1:3000/user/loggedLicense`,{
        headers: {
            'Content-Type' : 'application/json',
            'Accept' : 'application/json'
        },
